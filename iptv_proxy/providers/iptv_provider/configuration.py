...
class ProviderConfiguration(object):
    ...
    def _scrub_password(cls, configuration_object, configuration):
        ...
        password = SecurityManager.scrub_password(
            section_name, configuration_object[section_name]['password']
        )
    ...
    def create_section(cls, configuration):
        ...
        try:
            if 'service' in cls._configuration_schema['Provider']:
                configuration_section['service'] = configuration[
                    '{0}_SERVICE'.format(configuration_parameter_name_prefix)
                ]

            if 'server' in cls._configuration_schema['Provider']:
                configuration_section['server'] = configuration[
                    '{0}_SERVER'.format(configuration_parameter_name_prefix)
                ]

            if 'url' in cls._configuration_schema['Provider']:
                configuration_section['url'] = configuration[
                    '{0}_URL'.format(configuration_parameter_name_prefix)
                ]

            if 'username' in cls._configuration_schema['Provider']:
                configuration_section['username'] = configuration[
                    '{0}_USERNAME'.format(configuration_parameter_name_prefix)
                ]

            if 'password' in cls._configuration_schema['Provider']:
                configuration_section['password'] = configuration[
                    '{0}_PASSWORD'.format(configuration_parameter_name_prefix)
                ]
            ...
            if 'Playlist' in cls._configuration_schema:
                ...
                if 'protocol' in cls._configuration_schema['Playlist']:
                    configuration_section['Playlist']['protocol'] = configuration[
                        '{0}_PLAYLIST_PROTOCOL'.format(
                            configuration_parameter_name_prefix
                        )
                    ]

                if 'type' in cls._configuration_schema['Playlist']:
                    configuration_section['Playlist']['type'] = configuration[
                        '{0}_PLAYLIST_TYPE'.format(configuration_parameter_name_prefix)
                    ]
            ...
            if 'EPG' in cls._configuration_schema:
                ...
                if 'source' in cls._configuration_schema['EPG']:
                    configuration_section['EPG']['source'] = configuration[
                        '{0}_EPG_SOURCE'.format(configuration_parameter_name_prefix)
                    ]

                if 'url' in cls._configuration_schema['EPG']:
                    if (
                        configuration[
                            '{0}_EPG_URL'.format(configuration_parameter_name_prefix)
                        ]
                        is not None
                    ):
                        configuration_section['EPG']['url'] = configuration[
                            '{0}_EPG_URL'.format(configuration_parameter_name_prefix)
                        ]
                    else:
    ...
    def process_configuration_file_updates(cls, configuration, previous_configuration):
        ...
        provider_in_previous_configuration = len(
            [
                parameter_name
                for parameter_name in previous_configuration
                if parameter_name.startswith(configuration_parameter_name_prefix)
            ]
        )
        ...
        if provider_in_configuration and provider_in_previous_configuration:
            ...
            if 'service' in cls._configuration_schema['Provider']:
                service_parameter_name = '{0}_SERVICE'.format(
                    configuration_parameter_name_prefix
                )
            ...
            if 'server' in cls._configuration_schema['Provider']:
                server_parameter_name = '{0}_SERVER'.format(
                    configuration_parameter_name_prefix
                )
            ...
            if 'url' in cls._configuration_schema['Provider']:
                url_parameter_name = '{0}_URL'.format(
                    configuration_parameter_name_prefix
                )
            ...
            if 'username' in cls._configuration_schema['Provider']:
                username_parameter_name = '{0}_USERNAME'.format(
                    configuration_parameter_name_prefix
                )
            ...
            if 'password' in cls._configuration_schema['Provider']:
                password_parameter_name = '{0}_PASSWORD'.format(
                    configuration_parameter_name_prefix
                )

                if (
                    configuration[password_parameter_name]
                    != previous_configuration[password_parameter_name]
                ):
                    do_reinitialize = True
                    do_refresh_session = True
            ...
            if (
                'Playlist' in cls._configuration_schema
                and 'protocol' in cls._configuration_schema['Playlist']
            ):
                playlist_protocol_parameter_name = '{0}_PLAYLIST_PROTOCOL'.format(
                    configuration_parameter_name_prefix
                )
            ...
            if (
                'Playlist' in cls._configuration_schema
                and 'type' in cls._configuration_schema['Playlist']
            ):
                playlist_type_parameter_name = '{0}_PLAYLIST_TYPE'.format(
                    configuration_parameter_name_prefix
                )

                if (
                    configuration[playlist_type_parameter_name]
                    != previous_configuration[playlist_type_parameter_name]
                ):
                    if message_to_log:
                        message_to_log.append('')
            ...
            if (
                'EPG' in cls._configuration_schema
                and 'source' in cls._configuration_schema['EPG']
            ):
                epg_source_parameter_name = '{0}_EPG_SOURCE'.format(
                    configuration_parameter_name_prefix
                )

                if (
                    configuration[epg_source_parameter_name]
                    != previous_configuration[epg_source_parameter_name]
                ):
                    do_reinitialize = True
            ...
            if (
                'EPG' in cls._configuration_schema
                and 'url' in cls._configuration_schema['EPG']
            ):
                epg_source_parameter_name = '{0}_EPG_SOURCE'.format(
                    configuration_parameter_name_prefix
                )
                epg_url_parameter_name = '{0}_EPG_URL'.format(
                    configuration_parameter_name_prefix
                )
                ...
                if (
                    ...
                    if (
                        ...
                        != previous_configuration[epg_url_parameter_name]
                    ):
                        do_reinitialize = True
                        ...
                        message_to_log.append(
                            ...
                            ''.format(
                                previous_configuration[epg_url_parameter_name]
                                if previous_configuration[epg_url_parameter_name]
                                is not None
                                else 'N/A',
                                configuration[epg_url_parameter_name],
                            )
            ...
            if message_to_log:
                if do_reinitialize:
                    message_to_log.append(
                        'Action => Reinitializing {0}'.format(section_name)
                    )
                else:
                ...
                if do_reinitialize:
                    ProvidersController.initialize_provider(
                        cls._provider_name, do_refresh_session=do_refresh_session
                    )
            else:
                logger.debug('No changes detected in the %s section', section_name)
        elif provider_in_configuration and not provider_in_previous_configuration:
            logger.debug('Detected the addition of the %s section', section_name)
            ...
            logger.debug('Detected the removal of the %s section', section_name)
    ...
    def read_configuration_file(
        ...
        try:
            ...
            if 'url' in cls._configuration_schema['Provider']:
                try:
                    ...
                    error_message_to_log.append(
                        'Could not find a url option in the [{0}] section\n'.format(
                            section_name
                        )
                    )
            ...
            if 'username' in cls._configuration_schema['Provider']:
                try:
                    ...
                    error_message_to_log.append(
                        'Could not find a username option in the [{0}] section\n'.format(
                            section_name
                        )
                    )
            ...
            if 'password' in cls._configuration_schema['Provider']:
                try:
                    ...
                    error_message_to_log.append(
                        'Could not find a password option in the [{0}] section\n'.format(
                            section_name
                        )
                    )
            ...
            if 'Playlist' in cls._configuration_schema:
                try:
                    ...
                    if 'protocol' in cls._configuration_schema['Playlist']:
                        playlist_protocol = (
                            provider_map_class.constants_class().DEFAULT_PLAYLIST_PROTOCOL
                        )
                                ...
                                error_message_to_log.append(
                                    ...
                                    '{0}Defaulting to {1}\n'.format(
                                        '\n'.join(
                                            [
                                                '\u2022 {0}'.format(protocol)
                                                for protocol in provider_map_class.constants_class().VALID_PLAYLIST_PROTOCOL_VALUES
                                            ]
                                        ),
                                        playlist_protocol,
                                    )
                    ...
                    if 'type' in cls._configuration_schema['Playlist']:
                        playlist_type = (
                            provider_map_class.constants_class().DEFAULT_PLAYLIST_TYPE
                        )
            ...
            if 'EPG' in cls._configuration_schema:
                try:
                    ...
                    if 'source' in cls._configuration_schema['EPG']:
                        epg_source = (
                            provider_map_class.constants_class().DEFAULT_EPG_SOURCE
                        )
                                ...
                                error_message_to_log.append(
                                    ...
                                    'Defaulting to {1}\n'.format(
                                        '\n'.join(
                                            [
                                                '\u2022 {0}'.format(source)
                                                for source in provider_map_class.constants_class().VALID_EPG_SOURCE_VALUES
                                            ]
                                        ),
                                        epg_source,
                                    )
                    ...
                    if 'url' in cls._configuration_schema['EPG']:
                        try:
                            ...
                            if epg_source == provider_map_class.epg_source_enum().OTHER.value and not provider_map_class.validations_class().is_valid_url(
                                epg_url
                            ):
                                error_message_to_log.append(
        ...
        if is_valid_section:
            ...
            if (
                ...
                configuration[
                    '{0}_PLAYLIST_PROTOCOL'.format(configuration_parameter_name_prefix)
                ] = playlist_protocol
            ...
            message_to_log.append(
                ...
                '{8}'.format(
                    '{0}_SERVICE           => {1}\n'.format(
                        configuration_parameter_name_prefix, service
                    )
                    if service is not None
                    else '',
                    '{0}_SERVER            => {1}\n'.format(
                        configuration_parameter_name_prefix, server
                    )
                    if server is not None
                    else '',
                    '{0}_URL               => {1}\n'.format(
                        configuration_parameter_name_prefix, url
                    )
                    if url is not None
                    else '',
                    '{0}_USERNAME          => {1}\n'.format(
                        configuration_parameter_name_prefix, username
                    )
                    ...
                    '{0}_PASSWORD          => {1}\n'.format(
                        configuration_parameter_name_prefix,
                        password
                        if SecurityManager.is_password_decrypted(password)
                        else SecurityManager.decrypt_password(password).decode(),
                    )
                    if password is not None
                    else '',
                    '{0}_PLAYLIST_PROTOCOL => {1}\n'.format(
                        configuration_parameter_name_prefix, playlist_protocol
                    )
                    if playlist_protocol is not None
                    else '',
                    '{0}_PLAYLIST_TYPE     => {1}\n'.format(
                        configuration_parameter_name_prefix, playlist_type
                    )
                    if playlist_type is not None
                    else '',
                    '{0}_EPG_SOURCE        => {1}'.format(
                        configuration_parameter_name_prefix, epg_source
                    )
                    if epg_source is not None
                    else '',
                    '\n'
                    '{0}_EPG_URL           => {1}'.format(
                        configuration_parameter_name_prefix, epg_url
                    )
    ...
    def validate_update_configuration_request(cls, configuration, errors):
        ...
        section_name = provider_map_class.api_class().__name__
        configuration_parameter_name_prefix = section_name.upper()
        errors_parameter_name_prefix = '{0}{1}'.format(
            section_name[0].lower(), section_name[1:]
        )

        provider_in_configuration = (
            len(
                [
                    parameter_name
                    for parameter_name in configuration
            ...
            if 'service' in cls._configuration_schema['Provider']:
                try:
                    if not provider_map_class.validations_class().is_valid_service(
                        ...
                        errors[
                            '{0}Service'.format(errors_parameter_name_prefix)
                        ] = 'Must be one of [{0}]'.format(
                            ', '.join(
                                [
                                    '\'{0}\''.format(service)
                                    for service in provider_map_class.constants_class().VALID_SERVICE_VALUES
            ...
            if 'server' in cls._configuration_schema['Provider']:
                try:
                    if not provider_map_class.validations_class().is_valid_server(
                        ...
                        errors[
                            '{0}Server'.format(errors_parameter_name_prefix)
                        ] = 'Must be one of [{0}]'.format(
                            ', '.join(
                                [
                                    '\'{0}\''.format(server)
            ...
            if 'url' in cls._configuration_schema['Provider']:
                try:
                    if not provider_map_class.validations_class().is_valid_url(
                        ...
                        errors[
                            '{0}Url'.format(errors_parameter_name_prefix)
                        ] = 'Must be a valid url'
                except KeyError:
                    errors[
                        '{0}Username'.format(errors_parameter_name_prefix)
                    ] = 'Must not be an empty value'
            ...
            if 'password' in cls._configuration_schema['Provider']:
                try:
                    if not provider_map_class.validations_class().is_valid_password(
                        ...
                        errors[
                            '{0}Password'.format(errors_parameter_name_prefix)
                        ] = 'Must not be an empty value'
                except KeyError:
                    errors[
                        '{0}Password'.format(errors_parameter_name_prefix)
            ...
            if (
                ...
                try:
                    if not provider_map_class.validations_class().is_valid_playlist_protocol(
                        ...
                        errors[
                            '{0}PlaylistProtocol'.format(errors_parameter_name_prefix)
                        ] = 'Must be one of [{0}]'.format(
                            ', '.join(
                                [
                                    '\'{0}\''.format(service)
                                    for service in provider_map_class.constants_class().VALID_PLAYLIST_PROTOCOL_VALUES
                                ]
                            )
                        )
                except KeyError:
            ...
            if (
                ...
                try:
                    if not provider_map_class.validations_class().is_valid_playlist_type(
                        ...
                        errors[
                            '{0}PlaylistType'.format(errors_parameter_name_prefix)
                        ] = 'Must be one of [{0}]'.format(
                            ', '.join(
                                [
                                    '\'{0}\''.format(service)
            ...
            if (
                ...
                try:
                    if not provider_map_class.validations_class().is_valid_epg_source(
                        ...
                        errors[
                            '{0}EpgSource'.format(errors_parameter_name_prefix)
                        ] = 'Must be one of [{0}]'.format(
                            ', '.join(
                                [
                                    '\'{0}\''.format(service)
            ...
            if (
                ...
                try:
                    if (
                        ...
                        == provider_map_class.epg_source_enum().OTHER.value
                        and not provider_map_class.validations_class().is_valid_url(
                            configuration[
                                '{0}_EPG_URL'.format(
                                    configuration_parameter_name_prefix
                                )
                        ...
                        errors[
                            '{0}EpgUrl'.format(errors_parameter_name_prefix)
                        ] = 'Must be a valid url to a XMLTV file'
                except KeyError:
                    errors[
                        '{0}EpgUrl'.format(errors_parameter_name_prefix)
                    ] = 'Must not be an empty value'
...
class ProviderOptionalSettings(object):
    ...
    def process_optional_settings_file_updates(
        cls, optional_settings, previous_optional_settings
    ):
        provider_map_class = ProvidersController.get_provider_map_class(
            cls._provider_name
        )
        ...
        if provider_map_class.api_class().is_attribute_supported(
            '_do_reduce_hls_stream_delay'
        ):
            ...
            if (
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        reduce_delay_key_name,
                        json.dumps(
                            previous_optional_settings[reduce_delay_key_name], indent=2
                        ),
                        json.dumps(optional_settings[reduce_delay_key_name], indent=2),
                    )
                )

                provider_map_class.api_class().set_do_reduce_hls_stream_delay(
                    optional_settings[reduce_delay_key_name]
                )
        # </editor-fold>
        ...
        if provider_map_class.epg_class().is_attribute_supported('_channel_group_map'):
            channel_group_map_key_name = '{0}_channel_group_map'.format(
                cls._provider_name
            )
            ...
            if (
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        channel_group_map_key_name,
                        json.dumps(
                            previous_optional_settings[channel_group_map_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[channel_group_map_key_name], indent=2
                        ),
                    )
                )
        ...
        if provider_map_class.epg_class().is_attribute_supported('_channel_name_map'):
            channel_name_map_key_name = '{0}_channel_name_map'.format(
                cls._provider_name
            )
            ...
            if (
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        channel_name_map_key_name,
                        json.dumps(
                            previous_optional_settings[channel_name_map_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[channel_name_map_key_name], indent=2
                        ),
                    )
                )

                provider_map_class.epg_class().set_channel_name_map(
                    optional_settings[channel_name_map_key_name]
                )
        # </editor-fold>

        # <editor-fold desc="Detect and handle use_icons change">
        if provider_map_class.epg_class().is_attribute_supported(
            '_do_use_provider_icons'
        ):
            ...
            if (
                optional_settings[use_provider_icons_key_name]
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        use_provider_icons_key_name,
                        json.dumps(
                            previous_optional_settings[use_provider_icons_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[use_provider_icons_key_name], indent=2
                        ),
                    )
                )

                provider_map_class.epg_class().set_do_use_icons_key_name(
                    optional_settings[use_provider_icons_key_name]
                )
        # </editor-fold>
        ...
        if provider_map_class.epg_class().is_attribute_supported('_ignored_channels'):
            ignored_channels_key_name = '{0}_ignored_channels'.format(
                cls._provider_name
            )
            ...
            if ignored_channels_key_name not in previous_optional_settings:
                previous_optional_settings[ignored_channels_key_name] = {
                    'name': {},
                    'number': {},
                }
            ...
            if (
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        ignored_channels_key_name,
                        json.dumps(
                            previous_optional_settings[ignored_channels_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[ignored_channels_key_name], indent=2
                        ),
                    )
                )
        ...
        if provider_map_class.epg_class().is_attribute_supported(
            ...
            ignored_m3u8_groups_key_name = '{0}_ignored_m3u8_groups'.format(
                cls._provider_name
            )
            ...
            if (
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        ignored_m3u8_groups_key_name,
                        json.dumps(
                            previous_optional_settings[ignored_m3u8_groups_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[ignored_m3u8_groups_key_name], indent=2
                        ),
                    )
                )

                provider_map_class.epg_class().set_ignored_m3u8_groups(
                    optional_settings[ignored_m3u8_groups_key_name]
                )
        # </editor-fold>
        ...
        if provider_map_class.epg_class().is_attribute_supported('_m3u8_group_map'):
            ...
            if (
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        m3u8_group_map_key_name,
                        json.dumps(
                            previous_optional_settings[m3u8_group_map_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[m3u8_group_map_key_name], indent=2
                        ),
                    )
                )

                provider_map_class.epg_class().set_m3u8_group_map(
                    optional_settings[m3u8_group_map_key_name]
                )
        # </editor-fold>
        ...
        if provider_map_class.epg_class().is_attribute_supported('_update_times'):
            epg_update_times_key_name = '{0}_epg_update_times'.format(
                cls._provider_name
            )
            ...
            if (
                optional_settings[epg_update_times_key_name]
                != previous_optional_settings[epg_update_times_key_name]
            ):
                do_reinitialize = True
                ...
                message_to_log.append(
                    ...
                    'Old value => {1}\n'
                    'New value => {2}\n'.format(
                        epg_update_times_key_name,
                        json.dumps(
                            previous_optional_settings[epg_update_times_key_name],
                            indent=2,
                        ),
                        json.dumps(
                            optional_settings[epg_update_times_key_name], indent=2
                        ),
                    )
                )

                provider_map_class.epg_class().set_update_times(
                    optional_settings[epg_update_times_key_name]
                )
        # </editor-fold>
        ...
        if message_to_log:
            if (
                do_reinitialize
                and cls._provider_name in ProvidersController.get_active_providers()
            ):
                message_to_log.append(
                    'Action => Reinitializing {0}'.format(
                        provider_map_class.api_class.__name__
                    )
                )
            else:
                message_to_log.append('Action => N/A')
